...
const projectImages = [
  {
    src: '/projects/tourist/textiles.png',
    title: 'Thai Textiles Research',
    description: 'Exploring 12 major types of traditional Thai textiles and their cultural significance',
  },
  {
    src: '/projects/tourist/site-analysis.png',
    title: 'Site Analysis',
    description: 'Sanam Luang, Bangkok - analyzing sunlight, wind patterns, and cultural context',
  },
  {
    src: '/projects/tourist/concept.png',
    title: 'Concept Development',
    description: 'Mood boards and material palette inspired by threads weaving Thai culture together',
  },
  {
    src: '/projects/tourist/plans.png',
    title: 'Floor Plans & Elevations',
    description: 'Zoning diagrams, architectural plans, and elevation drawings',
  },
  {
    src: '/projects/tourist/renders.png',
    title: '3D Visualization',
    description: 'Final renders and isometric views bringing the design to life',
  },
]

export default function TouristProjectPage() {
    ...
    <main className="min-h-screen bg-dk-black">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end pb-16 px-8 md:px-16 max-w-7xl mx-auto">
          ...
          >
            Weaving the tradition throughout generations
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 px-8 md:px-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          >
            ...
            <p className="font-display text-xl text-white">Sanam Luang, Bangkok</p>
          </motion.div>
          ...
          >
            ...
            <p className="font-display text-xl text-white">Tourist / Cultural Center</p>
          </motion.div>
          ...
          >
            <h3 className="font-body text-xs tracking-widest uppercase text-white/40 mb-2">Concept</h3>
            <p className="font-display text-xl text-white">Thai Traditional Textiles</p>
          </motion.div>
        </div>
        ...
        >
          <p className="font-body text-white/70 leading-relaxed mb-6">
            Inspired by Thailand's rich textile heritage, <strong className="text-white">Tread of Tradition</strong> is
            a cultural tourist center that connects different parts of Thai culture, just like how threads connect
            to form a fabric. The design celebrates the 12 major types of traditional Thai textiles, each representing
            distinct regional identities from North, Northeast, Central, and South Thailand.
          </p>
          <p className="font-body text-white/70 leading-relaxed">
            Located at the historic Sanam Luang in the heart of Bangkok, the center serves as a living museum
            where visitors can experience Thai craftsmanship, storytelling, and cultural pride through immersive
            spaces designed to honor tradition while embracing contemporary aesthetics.
          </p>
        </motion.div>
      </section>
                  ...
                  <div
                    ...
                    style={{
                      background: index % 2 === 0
                        ...
                        : 'radial-gradient(ellipse at center, rgba(232, 90, 155, 0.2) 0%, transparent 70%)',
                      filter: 'blur(40px)',
                    }}
                  />
