...
const projectImages = [
  {
    src: '/projects/home-office-2/design-1.png',
    title: 'User Analysis & Context',
    description: 'Understanding the creative workforce needs and Worcester location context',
  },
  {
    src: '/projects/home-office-2/design-2.png',
    title: 'Style Concept & Sustainability',
    description: 'Modern Scandinavian design with eco-friendly materials and natural warmth',
  },
  {
    src: '/projects/home-office-2/design-3.png',
    title: 'Floor Plans & Sections',
    description: 'Open circulation layout with biophilic elements and natural lighting',
  },
  {
    src: '/projects/home-office-2/design-4.png',
    title: 'Sustainability Features',
    description: 'Energy efficiency, rainwater collection, and resource conservation systems',
  },
]

export default function HomeOffice2ProjectPage() {
    ...
    <main className="min-h-screen bg-dk-black">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end pb-16 px-8 md:px-16 max-w-7xl mx-auto">
          <motion.span
            ...
            className="font-body text-sm tracking-[0.3em] uppercase text-amber-400 mb-4"
          >
          ...
          >
            ...
            <span
              className="italic"
              style={{
                background: 'linear-gradient(90deg, #92754b 0%, #c9a86c 100%)',
          ...
          >
            Calm comfort, creative inspiration, natural warmth
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 px-8 md:px-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          >
            ...
            <p className="font-display text-xl text-white">Worcester, Massachusetts</p>
          </motion.div>
          ...
          >
            ...
            <p className="font-display text-xl text-white">Creative Home Office</p>
          </motion.div>
          ...
          >
            ...
            <p className="font-display text-xl text-white">Modern Scandinavian</p>
          </motion.div>
        </div>
        ...
        >
          <p className="font-body text-white/70 leading-relaxed mb-6">
            <strong className="text-white">Home Office</strong> is a sustainable workspace designed for
            graphic designers and creative professionals in Worcester, Massachusetts. The design blends
            Modern Minimal, Scandinavian, and Industrial elements to create a calm, inspiring environment.
          </p>
          <p className="font-body text-white/70 leading-relaxed">
            Sustainability is at the core of this project, featuring minimal physical waste, low energy
            consumption, eco-friendly materials, and biophilic design elements. The warm, minimal, and
            professional tone avoids harsh colors while embracing natural warmth and comfort.
          </p>
        </motion.div>
      </section>
          ...
          {projectImages.map((image, index) => (
            ...
            >
              ...
              <div className="w-full md:w-2/3 relative group">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: 'radial-gradient(ellipse at center, rgba(180, 140, 80, 0.2) 0%, transparent 70%)',
                      filter: 'blur(40px)',
                    }}
                  />
              ...
              <div className="w-full md:w-1/3 space-y-4">
                <span className="font-body text-xs tracking-widest uppercase text-amber-500">
                  Step {index + 1}
                </span>
      ...
      <section className="py-20 px-8 md:px-16">
        <div className="max-w-7xl mx-auto text-center">
          <div className="h-px bg-gradient-to-r from-transparent via-amber-600/30 to-transparent mb-16" />
