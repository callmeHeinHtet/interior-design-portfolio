...
const projectImages = [
  {
    src: '/projects/home-office/design-1.png',
    title: 'Concept & Moodboard',
    description: 'User analysis, space analysis, material board, and color palette for a modern eclectic fusion style',
  },
  {
    src: '/projects/home-office/design-2.png',
    title: 'Floor Plan & Perspectives',
    description: 'Spatial layout and 3D visualization of the bedroom, living area, and home office spaces',
  },
]

export default function HomeOfficeProjectPage() {
    ...
    <main className="min-h-screen bg-dk-black">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            src="/projects/home-office/design-1.png"
            alt="Nick and Carrie Home Office"
            fill
        ...
        <div className="relative z-10 h-full flex flex-col justify-end pb-16 px-8 md:px-16 max-w-7xl mx-auto">
          ...
          >
            A harmonious blend of cultures and creativity
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 px-8 md:px-16 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          >
            ...
            <p className="font-display text-xl text-white">Nick and Carrie</p>
          </motion.div>
          ...
          >
            ...
            <p className="font-display text-xl text-white">Home Office / Studio</p>
          </motion.div>
          ...
          >
            ...
            <p className="font-display text-xl text-white">Modern Eclectic Fusion</p>
          </motion.div>
        </div>
        ...
        >
          <p className="font-body text-white/70 leading-relaxed mb-6">
            <strong className="text-white">Nick and Carrie</strong> is a home office design project for popular
            Australian YouTube content creators. The space reflects their multicultural backgrounds, blending
            Asian and Western influences into a harmonious environment that supports both their creative work
            and personal lifestyle.
          </p>
          <p className="font-body text-white/70 leading-relaxed">
            The design emphasizes a clean, uncluttered aesthetic with cozy functionality. Natural materials
            like wood and linen combine with warm neutral tones to create a calm atmosphere perfect for
            content creation while maintaining the elegance of a sophisticated home.
          </p>
        </motion.div>
      </section>
